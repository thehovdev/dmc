...
class ContactPersonIndex extends Component {
    ...
    getContactPersons (page = 1) {
        ...
        return contactPersonApi.getContactPersons(action, page);
    }
    ...
    render() {
        ...
        const contactPerson = this.props.contactPerson.contactPersonData;
        const contactPersons = this.props.contactPerson.contactPersonsData;
        ...
        const updateContactPerson = (id) => {
            return contactPersonAction.updateContactPerson(id);
        }

        const editContactPerson = (id) => {
            if(id == false) {
                return contactPersonAction.editContactPerson(false);
            } else {

                companyApi.getCompaniesAll(companyAction)

                contactPersonApi.getContactPerson(contactPersonAction, id);
            }
        }

        const deleteContactPerson  = (id) => {
            return contactPersonApi.deleteContactPerson(contactPersonAction, id);
        }
